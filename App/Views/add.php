<div class="wrap">
    ...
    <pre><?php var_dump($flashMessages); ?></pre>
		...
		<table class="form-table">
			<tbody>
				<tr valign="top">
					...
					<td>
                        <input name="author" type="text" id="author" value="<?php echo ( isset($flashMessages['inputs']['author']) ? $flashMessages['inputs']['author'] : '' ); ?>" class="regular-text" placeholder="Joe Blogs">
				...
				<tr valign="top">
					...
					<td>
                        <input name="email" type="text" id="email" value="<?php echo ( isset($flashMessages['inputs']['email']) ? $flashMessages['inputs']['email'] : '' ); ?>" class="regular-text" placeholder="joe.blogs@example.com">
				...
				<tr valign="top">
					...
					<td>
                        <input name="button_src" type="text" id="button_src" value="<?php echo ( isset($flashMessages['inputs']['button_src']) ? $flashMessages['inputs']['button_src'] : '' ); ?>" class="regular-text" placeholder="http://www.example.com/banner.gif">
				...
				<tr valign="top">
					...
					<td>
                        <input name="link_url" type="text" id="link_url" value="<?php echo ( isset($flashMessages['inputs']['link_url']) ? $flashMessages['inputs']['link_url'] : '' ); ?>" class="regular-text" placeholder="http://www.example.com">
